...
export default function Home() {
  ...
  const [currentStep, setCurrentStep] = useState(1); // 1: New Model Form, 2: Upload/Pricing
  ...
  const handleUploadComplete = () => {
    setCurrentStep(3);
    setTimeout(() => {
      // Go back to "My Models" after completion
  ...
  return (
    <main className="bg-neutral-950 flex flex-col items-center p-24 pt-12 text-white min-h-[calc(100vh-53px)] min-w-2xl">
      {currentStep === 1 && <NewModelReleaseForm onNext={handleFormNext} />}
