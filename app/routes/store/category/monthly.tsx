...
export function meta({}) {
  return [
    { title: "스토어" },
    { name: "description", content: "Store > Event Detection > Monthly Popular Model" },
  ];
}
...
const DUMMY_DATA = dummy.filter(d=>d.category==='monthly')
  ...
  return(
    <main className="bg-black text-white min-h-[calc(100vh-441px)] px-6 pt-2 pb-6 max-w-[1520px]">
      <div className="bg-black py-4 sticky top-[77px] mb-2">
        <h1 className="float-left">월간 인기모델</h1>
