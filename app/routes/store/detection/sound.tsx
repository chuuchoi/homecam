...
export function meta({}) {
  return [
    { title: "스토어" },
    { name: "description", content: "Store > Event Detection > Sound Detection Model " },
  ];
}

const DUMMY_DATA = dummy.filter(d=>d.detect_type==='sound')
  ...
  return(
    <main className="bg-black text-white min-h-[calc(100vh-441px)] px-6 pt-2 pb-6 max-w-[1520px]">
      <div className="bg-black py-4 sticky top-[77px] mb-2">
        <h1 className="float-left">소리감지 모델</h1>
