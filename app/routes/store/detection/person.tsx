...
export function meta({}) {
  return [
    { title: "스토어" },
    { name: "description", content: "Store > Event Detection > Person Detection Model" },
  ];
}

const DUMMY_DATA = dummy.filter(d=>d.detect_obj==='person')
