...
export function meta({}) {
  return [
    { title: "스토어" },
    { name: "description", content: "Store > Event Detection > Animal Detection Model" },
  ];
}

const DUMMY_DATA = dummy.filter(d=>d.detect_obj==='animal')
